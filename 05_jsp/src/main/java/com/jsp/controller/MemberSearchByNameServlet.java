...
/**
 * Servlet implementation class MemberSearchByName
 */
@WebServlet("/memberName.do")//앞의 경로를 생략했을뿐 절대경로이다
public class MemberSearchByNameServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<MemberDTO> members=new MemberService().searchMemberByName(name);
